...
import 'package:quiqliq/screens/home_advertisement.dart';
import 'package:quiqliq/screens/home_professional.dart';
...
import 'package:quiqliq/widgets/draw.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ElevatedButton(
            onPressed: () => Navigator.pushNamed(context, "downloadApk"),
            child: Text("App"),
          ),
        ],
        centerTitle: true,
